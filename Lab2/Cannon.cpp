...
float xCoordinate = 38.88; //Cannon ball x-corrdinate
float yCoordinate = 64; //Cannon ball y-corrdinate
float xVelocity = cos(30 * M_PI / 180) * 5;
float yVelocity = sin(30 * M_PI / 180) * 5;
...
//----------handles the movement of the cannon ball----------------
...
void keyboard(unsigned char key, int x, int y)
{
    switch(key)
    {
        case ' ': glutTimerFunc(50, fireBall, 0); break;
    }
    glutPostRedisplay();
}
