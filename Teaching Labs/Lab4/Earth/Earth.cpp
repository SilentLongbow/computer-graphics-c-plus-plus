...
void display()  
{
	...
	glPushMatrix();
        glRotatef(revolveAngle, 0.0, 1.0, 0.0);
	    glTranslatef(20.0, 0.0, 0.0);	 //Translate Earth along x-axis by 20 units	
        glRotatef(rotateAngle, 0, 1, 0);       //Rotation about polar axis of the Earth
...
void timer(int value)
{
    ...
    revolveAngle += 0.5;
    if(revolveAngle > 360) revolveAngle = 0;
