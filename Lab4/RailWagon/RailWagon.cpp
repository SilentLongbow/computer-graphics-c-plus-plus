...
void wagon()
{
	...
	glBegin(GL_QUADS);
      ...
      glTexCoord2f(1.0, 0.3398);    glVertex3f(35.0, 17.0, 6.0);
      glTexCoord2f(0., 0.3398);     glVertex3f(-35.0, 17.0, 6.0);

	  glNormal3f(0.0, 0.0, -1.0);   //Facing -z (Back side)
      glTexCoord2f(1., 0.);         glVertex3f(35.0, 5.0, -6.0);
      glTexCoord2f(0., 0.);         glVertex3f(-35.0, 5.0,-6.0);
      glTexCoord2f(0., 0.3398);     glVertex3f(-35.0, 17.0,-6.0);
      glTexCoord2f(1., 0.3398);     glVertex3f(35.0, 17.0, -6.0);

	  glNormal3f(0.0, 1.0, 0.0);   //Facing +y (Top side)
      glTexCoord2f(0., 0.4492);     glVertex3f(-35.0, 17.0, 6.0);
      glTexCoord2f(1., 0.4492);     glVertex3f(35.0, 17.0,  6.0);
      glTexCoord2f(1., 0.8281);     glVertex3f(35.0, 17.0, -6.0);
      glTexCoord2f(0., 0.8281);     glVertex3f(-35.0, 17.0, -6.0);
	glEnd();
